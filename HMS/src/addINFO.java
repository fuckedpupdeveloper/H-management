...
public class addINFO extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please Enter the Guest Info");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 0, 255));
        jLabel3.setText("GuestID");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Single", "Double", "Laxury", "Double-Laxury" }));
        ...
        setSize(new java.awt.Dimension(449, 529));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try
       {
       String SQL ="INSERT INTO guest (id,name,address,city,roomtype) VALUES (?,?,?,?,?)";
       ...
       pst.execute();
       JOptionPane.showMessageDialog(null,"INFO ADDED SUCESSFULLY");
        }
       catch(Exception e)
       {
